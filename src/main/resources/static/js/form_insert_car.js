...
const formSubmitButton = document.getElementById("submitCarButton");

formSubmitButton.addEventListener("click", (event) => {
    makeDropdown.options[makeDropdown.selectedIndex].value = makeDropdown.options[makeDropdown.selectedIndex].text
});